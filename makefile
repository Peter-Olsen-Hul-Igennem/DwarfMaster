#******************************************************************************
# Generated by VisualTeensy V1.5.0 on 04-08-2022 at 13:47
#
# Board              Teensy 4.1
# USB Type           MIDI
# CPU Speed          600 MHz
...
TARGET_NAME      := DwarfMaster
BOARD_ID         := TEENSY41

MCU              := imxrt1062

LIBS_SHARED_BASE := C:\Users\peter\Documents\Arduino\libraries
LIBS_SHARED      := ArduinoJson Adafruit_BusIO Adafruit_TouchScreen Adafruit_GFX_Library MCUFRIEND_kbv 

LIBS_LOCAL_BASE  := lib
LIBS_LOCAL       := EEPROM SD SdFat SPI Wire MIDI 

CORE_BASE        := cores\teensy4
GCC_BASE         := C:\PROGRA~2\Arduino\hardware\tools\arm\bin
UPL_PJRC_B       := C:\PROGRA~2\Arduino\hardware\tools
UPL_TYCMD_B      := C:\VisualTeensy\TyTools
...
DEFINES     := -D__IMXRT1062__ -DTEENSYDUINO=156 -DARDUINO_TEENSY41 -DARDUINO=10813
DEFINES     += -DF_CPU=600000000 -DUSB_MIDI -DLAYOUT_US_ENGLISH
